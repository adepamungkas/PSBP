...
<footer>
        ...
        <div class="col-md-7">
          ...
          <div class="col-sm-1 hidden-md-down">
            ...
            <div class="col-sm-11 text-white">
                <div><h4> Website</h4>
                    <p><span class="header-font">P</span>E<span class="header-font">M</span>NU.ac.id</p>
                </div>
            </div>
            </div>
        </div>
    ...
    <!--/.footer-->
<p class="text-center">Copyright @ Pondok Pesantren Modern Nahdlatul 'Ulama Talang Padang 2018 Powered By Codeigniter</p>
